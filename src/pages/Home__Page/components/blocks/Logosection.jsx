...
function Logosection() {
  return (
        <div className="grid lg:grid-cols-2 md:grid-cols-2 bg-black lg:mx-20 md:mx-10 mx-5 lg:mt-8 mt-4  text-white lg:py-16 md:py-12 py-10 lg:rounded-none rounded-md">
            <div className=" lg:ml-40 md:ml-20 ml-10 lg:mt-10">
                <div className="flex text-white">
                   ...
                   className="lg:w-14 lg:h-14 w-8 h-8"
                    src={apple} 
                    alt=""/>
                    <h1 className="pl-3 lg:pt-4 pt-2 lg:text-base text-sm">iphone 14 Series</h1>
                </div>
                <h3
                   className="pt-5 lg:text-6xl md:text-4xl text-xl font-medium tracking-wider ">
                   Up to 10% <span className="block mt-3">off Voucher</span>
                </h3>
            ...
            <div>
                <div className="lg:mt-8 mt-7 lg:ml-28 ml-4">
                    <img 
                    className="lg:w-[496px] md:w-[410px] w-[300px] lg:h-[352px] md:h-[230px] h-[230px]"
                    src={iphone}
                    alt=""/>
                </div>
